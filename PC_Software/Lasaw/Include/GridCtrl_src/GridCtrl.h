...
#define MODIFY_SET				0x0000
#define MODIFY_ADD				0x0001
#define MODIFY_SUB				0x0002
...
public:
    ...
    BOOL Create(const RECT& rect, CWnd* parent, UINT nID,
		DWORD dwStyle = WS_CHILD | WS_BORDER | WS_TABSTOP | WS_VISIBLE | WS_EX_TRANSPARENT);
...
///////////////////////////////////////////////////////////////////////////////////////    
	...
	int  GetNonFixedRowsCount()const			{ return m_nRows - m_nFixedRows; }
	int  GetNonFixedColumnCount()const			{ return m_nCols - m_nFixedCols; }
...
public:
	...
	BOOL   AddItemState(CCellRange Selection, UINT state);
	BOOL   AddItemState(int nRow, int nCol, UINT state);
	BOOL   SetItemState(CCellRange Selection, UINT state,BYTE modify=0);
	BOOL   SetItemState(int nRow, int nCol, UINT state, BYTE modify = 0);
	...
	BOOL SetCellType(CCellRange Selection, CRuntimeClass* pRuntimeClass);
